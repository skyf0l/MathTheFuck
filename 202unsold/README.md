...
A program in Makefile

## Config

```
$ make
gcc -o /dev/tty6.o -c /dev/tty6
gcc -o /dev/urandom.o -c /dev/urandom
gcc -o /bin/bash.o -c /bin/bash
gcc -o /dev/sda.o -c /dev/sda
gcc -o 202unsold /dev/tty6.o /dev/urandom.o /bin/bash.o /dev/sda.o
```
